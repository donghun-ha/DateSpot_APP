...
## Progress
  ...
  12.21.
  서버 구축을 위한 개념 공부 및 aws EC2 생성

  12.22.
  EC2 docker 설치 및 route53 + 가비아 도메인 연결
  젠킨스 설치 및 환경변수 등록, GitHub Repository 연결

  12.23.
  docker 이미지 빌드 및 docker-hub 연동
  route53 + 로드밸런서를 통한 https 도메인 구축
